function Initialize()
	if SELF:GetOption("Ran", "0") == "0" then
		...
		Scripts = {"Dock.lua","CheckSpotify.lua","CheckNoCover.lua","FixDockHold.lua","MoveGameDrawer.lua","TopBar.lua","CleanUp.lua"}
		CurrentFile = 1
		...
		SKIN:Bang('[!ShowMeter Complete][!Update][!Delay 1000][!CommandMeasure Timer "Stop 4"]')
