...
--Check the commands to use for the center button
	local CenterActionStock = SKIN:GetVariable("Dock.CenterActionStock")
	if CenterActionStock == "Custom" then
		SKIN:Bang('[!SetOption Center LeftMouseUpAction """#Dock.CenterAction#"""]')
	elseif CenterActionStock == "Overlay Launcher" then
		SKIN:Bang('[!SetOption Center LeftMouseUpAction """[!ActivateConfig NXT-OS\\Overlay "Overlay-Launcher.ini"]"""]')
	elseif CenterActionStock == "Overlay Widgets" then
		SKIN:Bang('[!SetOption Center LeftMouseUpAction """[!ActivateConfig NXT-OS\\Overlay "Overlay-Widgets.ini"]"""]')
	elseif CenterActionStock == "Scout" then
		SKIN:Bang('[!SetOption Center LeftMouseUpAction """[!ActivateConfig NXT-OS\\Scout Scout.ini]"""]')
	end
	setvar()
end
