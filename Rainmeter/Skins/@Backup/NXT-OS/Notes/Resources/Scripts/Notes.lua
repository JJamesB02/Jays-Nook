...
function FindFiles(RunAfter)
	...
	if table.getn(NOTESLIST) < 1 then
		...
		SKIN:Bang('[!SetOption Window.Title.Button.Trash ImageAlpha 255][!SetOption Window.Title.Button.Trash ButtonCommand """[play "#@#"][!HideMeterGroup "SideOverlay"][!ShowMeterGroup "Dialogue"][!Update]"""][!Update]')
	end
end
