	...
	for i=1,7 do 
		...
		if listView[index] ~= nil then
			...
			if listView[index]['launcher'] == 'User Added Games' then
				...
				SKIN:Bang('!SetOption', 'Delete'..i, 'LeftMouseUpAction', '[!SetVariable ToDeleteName "'..listView[index]['appName']..'"][!SetVariable ToDelete "'..listView[index]['appID']..'"][play "#@#"][!ShowMeterGroup Dialogue][!Update]')
