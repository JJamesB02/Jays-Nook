...
function setoptions()
	...
	for i=1,7 do 
		...
		if info[index] ~= nil then
			...
			SKIN:Bang('!SetOption','Delete'..i,'LeftMouseUpAction','[play "#@#"][!ShowMeterGroup Dialogue][!SetVariable ToDelete '..(i+position-1)..'][!SetVariable ToDeleteName "'..command..'"][!Update]')
		end
	end
	SKIN:Bang('!SetVariable','Scroll.Position',position)
	SKIN:Bang('!Update')
...
function Invoke(number)
	if number ~= nil then
		...
		SKIN:Bang('!SetOption','EditOKButton','LeftMouseUpAction','[!HideMeterGroup Edit][!Update][!Delay 300][!CommandMeasure Command Edit('..number..')]')
		SKIN:Bang('!ShowMeterGroup','Edit')
		SKIN:Bang('!Update')
	else
		SKIN:Bang('!SetVariable','TempKey','Key')
		SKIN:Bang('!SetVariable','TempCommand','Command')
		SKIN:Bang('!SetOption','EditOKButton','LeftMouseUpAction','[!HideMeterGroup Edit][!Update][!Delay 300][!CommandMeasure Command Edit()]')
		SKIN:Bang('!ShowMeterGroup','Edit')
		SKIN:Bang('!Update')
	end
end
